...
<head>
    ...
    <%--    <script type="text/javascript"--%>
    <%--            src="https://11wan.yy.com/s/h5_sdk/gameH5Sdk.js"></script>--%>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/game/cisha/gameH5Sdk.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/game/cisha/yy.js"></script>
</head>
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div class="pan">
        <form class="m-t" role="form" id="adminlogin" method="post" name="adminlogin" onsubmit="return false"
            ...
            <button type="button" class="btn btn-primary block full-width m-b" onclick=""> 一 键 注 册
            </button>
            <button type="button" class="btn btn-primary block full-width m-b" onclick=""> 登 录</button>
<%--            <div class="parent" >--%>
...
<%--            </div>--%>
            ...
            <p class="text-muted text-center">
                ...
                <a onclick="" style="float: left">返回游戏列表</a>
            </p>
        </form>
    </div>
</div>
