    ...
    <form id="fm" method="post" enctype="multipart/form-data">
        <div style="padding-top:50px;  float:left; width:95%; padding-left:30px;">
            <div id="i_do_wrap">
                ...
                <div class="i_do_div rel" id="picture"><p class="i_do_tle r_txt abs font14">展示图片</p></div>
...
<script type="text/javascript">
    ...
    function openPictureModifyDialog() {
        ...
        var html = '<img name="uploadify2" id="uploadify2"  type="file" />';
        $('#picture').append(html);
        var imghtml = '<img src="images/back.jpg" width="110" height="110" id="img11"  style="display:none;"/>' +
            '<input type="text" id="input11" name="path" value="' + row.path + '" style="display:none;" />';
        $('#pic11').append(imghtml);
