...
<head>
    ...
    <script type="text/javascript"
            src="http://zy.hysdgame.cn/sdk/common/libZySdk_v1.js?v=20200114"></script>
</head>
...
<div id="sp">
    ...
    <select title="选择区服" id="save_serverId" name="serverId">
        ...
        <option value="1" selected="selected">1 区</option>
            <option value="1" selected="selected">1 区</option>
            <option value="2" selected="selected">2 区</option>
            <option value="3" selected="selected">3 区</option>
            <option value="4" selected="selected">4 区</option>
            <option value="5" selected="selected">5 区</option>
            <option value="6" selected="selected">6 区</option>
    </select>
...
<script type="text/javascript">
    ...
    function init() {
        ...
        if (appId === "10")
            secretKey = "f1kn2ta5i3qkg7vi015dkq5muy0ii786";
        //YY
        let channelId_YY = 2;
        //乐趣
        let channelId_LQ = 3;
