...
<script>
    ...
    document.getElementById("confframe").src = "${pageContext.request.contextPath}/views/server/game_info.html?20200428" + param;
    ...
    function gameback() {
        window.location.href = "/views/game/gameInfo.jsp";
    }
</script>
</html>
