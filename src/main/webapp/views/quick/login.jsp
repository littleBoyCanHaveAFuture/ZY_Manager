...
<%--    <script type="text/javascript"--%>
<%--            src="https://staticjs.quickapi.net/static/lib/libQuickSDK_v2.js"></script>--%>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/views/quick/libQuickSDK_v2.js"></script>
    <script src="${pageContext.request.contextPath}/views/quick/login.js"></script>
</head>
