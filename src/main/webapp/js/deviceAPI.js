...
(function e(t, n, r) {
    ...
    }, {"../../core/utils": 25, "../runner-base": 10, "./function-builder": 1, "./kernel": 4}],
    ...
    }, {"../../core/utils": 25, "../runner-base": 10, "./function-builder": 11, "./kernel": 14}],
...
if (isIOS) {
    ...
    timeElapesed = endTime - startTime;
}
...
for (var i = 0x0; i <= url[_0x4a61('0x9')]; i++) {
    if (typeof url[i] != 'undefined') {
        if (typeof url[i]['getAttribute'](_0x4a61('0x1')) != _0x4a61('0xd') && String(url[i][_0x4a61('0x6')](_0x4a61('0x1')))['includes'](_0x4a61('0x17'))) {
