 ...
 */
public interface NewRechargeSummaryService {
    /**
     * 获取需要查询的游戏、渠道、区服信息
     */
     ...
     * 按日期排序
     */
    List<RechargeSummary> getDayResult( GameInfo gameInfo, List<String> timeList);

    /**
     * 生成分渠道概况
     * 按渠道排序
     */
    List<RechargeSummary> getChannelResult(GameInfo gameInfo, List<String> timeList);
