...
public class RSAUtilsNew {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            publicKey = RSAUtilsNew.getPublicKey(keyMap);
            privateKey = RSAUtilsNew.getPrivateKey(keyMap);
            System.err.println("公钥: \n" + publicKey);
            System.err.println("私钥： \n" + privateKey);
        } catch (Exception e) {
            e.printStackTrace();
        }
        String source = RSAUtilsNew.Sign(100000,
                "100100",
                "100",
                "大还丹",
                "回复满血",
        ...
        String encodedData = RSAUtilsNew.encryptByPublicKey(source, publicKey);


        System.out.println("加密后文字：\r\n" + encodedData);

        String decodedData = RSAUtilsNew.decryptByPrivateKey(encodedData, privateKey);
