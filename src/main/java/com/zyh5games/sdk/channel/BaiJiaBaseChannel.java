 ...
 */
@Component("9")
public class BaiJiaBaseChannel extends BaseChannel {
    private static final Logger log = Logger.getLogger(BaiJiaBaseChannel.class);
    ...
    public JSONArray commonLib() {
        ...
        libUrl.add("https://dm.233h5.com/static/sdk/xianxia.sdk.js");
        return libUrl;
    }
