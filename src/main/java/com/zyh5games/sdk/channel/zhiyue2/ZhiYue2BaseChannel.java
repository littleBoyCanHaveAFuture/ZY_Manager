package com.zyh5games.sdk.channel.zhiyue2;
 ...
 */
@Component("36")
public class ZhiYue2BaseChannel extends BaseChannel {
    private static final Logger log = Logger.getLogger(ZhiYue2BaseChannel.class);
    @Resource
    private AccountService accountService;

    ZhiYue2BaseChannel() {
        channelId = ChannelId.H5_ZhiYue2;
        channelName = "指悦分渠道2";
    }
